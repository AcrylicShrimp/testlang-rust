	...
	pub fn from_any_value(value_type: ValueType, any_value: AnyValueEnum<'ctx>) -> Value<'ctx> {
		match any_value {
			AnyValueEnum::IntValue(value) => match value_type {
				ValueType::Bool => Value::Bool { value: value },
				ValueType::I8 => Value::I8 { value: value },
				ValueType::I16 => Value::I16 { value: value },
				ValueType::I32 => Value::I32 { value: value },
				ValueType::I64 => Value::I64 { value: value },
				ValueType::I128 => Value::I128 { value: value },
				ValueType::U8 => Value::U8 { value: value },
				ValueType::U16 => Value::U16 { value: value },
				ValueType::U32 => Value::U32 { value: value },
				ValueType::U64 => Value::U64 { value: value },
				ValueType::U128 => Value::U128 { value: value },
				_ => panic!(
			...
			AnyValueEnum::FloatValue(value) => match value_type {
				ValueType::F16 => Value::F16 { value: value },
				ValueType::F32 => Value::F32 { value: value },
				ValueType::F64 => Value::F64 { value: value },
				_ => panic!(
					"value type mismatch; given value is not instance of {}",
					value_type
				),
			...
			AnyValueEnum::PointerValue(value) => match value_type {
				ValueType::Str => Value::Str { value: value },
				_ => panic!(
					"value type mismatch; given value is not instance of {}",
					value_type
				),
